...
class InvoiceDetail(db.Model):
    ...
    quantity = db.Column(db.Numeric(10, 6), nullable=False)
    unit_price = db.Column(db.Numeric(10, 6), nullable=False)
    discount = db.Column(db.Numeric(10, 6), nullable=False)
    price_without_tax = db.Column(db.Numeric(10, 6), nullable=False)
